//
//  TwoPhysicalAttributeCell.swift
...
/// A cell used for displaying two physical attributes.
final class TwoPhysicalAttributeCell: UICollectionViewCell, FontAdjustable, ReusableCellConfiguring {
    ...
    private let player1ScoreLabel: UILabel = {
        ...
        label.accessibilityHint = "Displays the first player's physical score".localized
        return label
    }()
    ...
    private let attributeNameLabel: UILabel = {
        ...
        label.isAccessibilityElement = true
        label.accessibilityHint = "Displays the name of the physical attribute".localized
        return label
    }()
    ...
    private let player2ScoreLabel: UILabel = {
        ...
        label.isAccessibilityElement = true
        label.accessibilityHint = "Displays the second player's physical score".localized
        return label
    }()
    ...
    /// Configures the cell with physical attribute scores and an attribute name.
    /// - Parameters:
    ...
    func configure(player1Score: Int, attributeName: String, player2Score: Int, index: Int, option: Int) {
        ...
        player1ScoreLabel.textColor = colorForScore(
            player1Score,
            option: option
        )
        player2ScoreLabel.textColor = colorForScore(
            player2Score,
            option: option
        )
    }
