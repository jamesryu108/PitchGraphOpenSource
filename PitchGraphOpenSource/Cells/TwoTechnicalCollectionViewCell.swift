//
//  TwoTechnicalCollectionViewCell.swift
...
/// A cell used for displaying two technical attributes of a player.
final class TwoTechnicalCollectionViewCell: UICollectionViewCell, FontAdjustable, ReusableCellConfiguring {
    ...
    private let player1ScoreLabel: UILabel = {
        ...
        label.accessibilityHint = "Displays the first player's technical score".localized
        return label
    }()
    ...
    private let attributeNameLabel: UILabel = {
        ...
        label.isAccessibilityElement = true
        label.accessibilityHint = "Displays the name of the technical attribute".localized
        return label
    }()
    ...
    private let player2ScoreLabel: UILabel = {
        ...
        label.isAccessibilityElement = true
        label.accessibilityHint = "Displays the second player's technical score".localized
        return label
    }()
